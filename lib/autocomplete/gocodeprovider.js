...
class GocodeProvider {
  constructor (goconfig) {
    ...
    let suppressSubscription = atom.config.observe('go-plus.autocomplete.suppressActivationForCharacters', (value) => {
    ...
    let snippetModeSubscription = atom.config.observe('go-plus.autocomplete.snippetMode', (value) => {
  ...
  filterSelectors () {
    let configSelectors = atom.config.get('go-plus.autocomplete.scopeBlacklist')
