  ...
  bounceGocode() {
    ...
    const notification = atom.notifications.addError('gocode', {
      ...
      description:
        ...
        os.EOL +
        os.EOL +
        'Often, running `gocode close && go get -u github.com/nsf/gocode` is able to fix the issue.' +
        os.EOL +
        os.EOL +
        'If this does not work and you are definitely running the latest version of `gocode`, you might want to search for open issues at <a href="https://github.com/nsf/gocode/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aopen%20panic">https://github.com/nsf/gocode/issues</a>.' +
        os.EOL +
        os.EOL +
        'Would you like to try running `gocode close && go get -u github.com/nsf/gocode` now?',
      buttons: [
        {
          text: 'Yes',
          onDidClick: () => {
