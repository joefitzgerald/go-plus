  ...
  getSuggestionForWord (editor, text, range) {
    ...
    return {
      ...
      callback: () => {
        ...
        // TODO: This doesn't look UTF-8 friendly
        const endOffset = editor.getBuffer().characterIndexForPosition(range.end)
        console.log(g)
        g.gotoDefinitionWithParameters(['-o', endOffset, '-i'], editor.getText())
      }
    }
  }
}
