...
const utf8OffsetForBufferPosition = (pos: WordPosition, editor: any = getEditor()) => {
 ...
 */
const openFile = (file: string, pos: any): Promise<any> => {
...
const parseGoPosition = (identifier: string): GoPos => {
  ...
  return {file: file, line: line, column}
}
