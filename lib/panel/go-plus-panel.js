...
export default class GoPlusPanel extends EtchComponent {
  ...
  handleToggleOrientation () {
    if (this.props.model.panelOrientation === 'vertical') {
      atom.config.set('go-plus.panel.orientation', 'horizontal')
    } else {
      atom.config.set('go-plus.panel.orientation', 'vertical')
    }
  }
  ...
  handleDoubleClick (e) {
    ...
    atom.config.set('go-plus.panel.currentHeight', vh)
    this.update()
  }
  ...
  handleMouseMove (e) {
    if (this.props.model.panelOrientation === 'vertical') {
      ...
      atom.config.set('go-plus.panel.currentWidth', vw)
    } else {
