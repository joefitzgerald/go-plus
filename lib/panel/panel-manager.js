...
class PanelManager {
  ...
  statusBar: () => atom$StatusBar | false
  goconfig: GoConfig
  goPlusStatusBar: ?GoPlusStatusBar
  goPlusStatusBarTile: ?atom$StatusBarTile

  constructor(statusBarFunc: () => atom$StatusBar | false) {
  ...
  showStatusBar() {
    ...
    const goPlusStatusBar = new GoPlusStatusBar({
      state: 'unknown',
      togglePanel: () => {
        this.togglePanel()
      }
    })
    this.goPlusStatusBar = goPlusStatusBar

    this.subscriptions.add(goPlusStatusBar)
